            ...
            <div className="max-w-[1170px] text-white mx-auto">
                <section className="border-b-[1px] border-gray-500 grid md:grid-cols-5 md:gap-4 pb-4 pt-4">
                    <div className="md:col-span-2">
                        ...
                        <div className='mt-6'>
                            <p className='text-justify text-sm max-w-[350px] w-full'>
                                <Link href="#" className='font-bold text-[#408BEA]'>Phimmoi</Link>
                    ...
                    <div className='mx-auto'>
                        ...
                        <ul className='text-[#408BEA] text-sm'>
                            <li className='m-2 ml-0'><Link href="#">
                            Phim khoa học</Link></li>
                            <li className='m-2 ml-0'><Link href="#">
                            Phim kinh dị</Link></li>
                            <li className='m-2 ml-0'><Link href="#">
                            Phim chiếu rạp</Link></li>
                            <li className='m-2 ml-0'><Link href="#">
                            Phim hình sự</Link></li>
                        </ul>
                    </div>
                    <div className='mx-auto'>
                        <h3>Phim hay</h3>
                        <ul className='text-[#408BEA] text-sm'>
                            ...
                            Phim Âu Mỹ</Link></li>
                            <li className='m-2 ml-0'><Link href="#">
                            Phim Hàn Quốc</Link></li>
                            <li className='m-2 ml-0'><Link href="#">
                            Phim Trung Quốc</Link></li>
                            <li className='m-2 ml-0'><Link href="#">
                            Phim Nhật Bản</Link></li>
                        </ul>
                    </div>
                    <div className='mx-auto'>
                         <h3>Thông tin</h3>
                        <ul className='text-[#408BEA] text-sm'>
                            ...
                            Giới thiệu</Link></li>
                            <li className='m-2 ml-0'><Link href="#">
                            Liên hệ chúng tôi</Link></li>
                            <li className='m-2 ml-0'><Link href="#">
                            Điều khoản sử dụng</Link></li>
                            <li className='m-2 ml-0'><Link href="#">
                            Chính sách riêng tư</Link></li>
                            <li className='m-2 ml-0'><Link href="#">
                            Khiếu nại bản quyền</Link></li>
                        </ul>
                    </div>
                </section>
                <section className='flex justify-between items-center py-6'>
                            ...
                            <div>
                                ...
                                <Link href="#" className="p-3 bg-gray-500 rounded">
